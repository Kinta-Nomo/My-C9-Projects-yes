...
var level2 = [['√','-#','i'],['1','2','3','#!'],['!','=','≠'],['÷','3','mod'],['3','√','3√'],['1','0','10'],['10','0','100'],['1','#/#','100','%'],['-#','→','#','||'],['#','#','#','{}']]
...
function levelup(){
    if (level == 1){
        ...
        var unlockables = ['#/#','.','!','0',',','→']
        console.log(gameSlider.discovered,unlockables)
        gameSlider.discovered = gameSlider.discovered.concat(unlockables)
    }
}
