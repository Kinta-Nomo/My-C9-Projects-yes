...
function rotateObject(MyObject,o,angle,rotateStat){
...
function draw(){
    ...
    projectPoints=rotateObject(newPoints,o,anglex,[0,1])
    projectPoints=rotateObject(projectPoints,o,angley,[0,2])
    projectPoints=rotateObject(projectPoints,o,anglez,[1,2])
