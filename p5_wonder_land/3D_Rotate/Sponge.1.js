...
function cube(x,y,z,l,n){
    ...
    var len = l/3.0
    cube(x,y,z+len,len,n-1)
    cube(x+len+len,y,z+len,len,n-1)
    
    
    
    cube(x,y+len+len,z+len,len,n-1)
    
    cube(x+len+len,y+len+len,z+len,len,n-1)
    
    
    cube(x,y,z+len+len,len,n-1)
    cube(x+len,y,z+len+len,len,n-1)
    cube(x+len+len,y,z+len+len,len,n-1)
    cube(x,y+len,z+len+len,len,n-1)
    
    cube(x+len+len,y+len,z+len+len,len,n-1)
    cube(x,y+len+len,z+len+len,len,n-1)
    cube(x+len,y+len+len,z+len+len,len,n-1)
    cube(x+len+len,y+len+len,z+len+len,len,n-1)
    
    
    cube(x,y,z,len,n-1)
    cube(x+len,y,z,len,n-1)
    cube(x+len+len,y,z,len,n-1)
    cube(x,y+len,z,len,n-1)
    
    cube(x+len+len,y+len,z,len,n-1)
    cube(x,y+len+len,z,len,n-1)
    cube(x+len,y+len+len,z,len,n-1)
